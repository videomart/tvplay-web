...
export function GraphicOverlay({ graphic }: { graphic: GraphicConfig }) {
  ...
  return (
    <>
      ...
      <div className="absolute z-10 top-2 left-2 flex items-center gap-1 bg-violet-900/60 text-violet-300 text-[9px] px-1.5 py-0.5 rounded font-mono pointer-events-none">
