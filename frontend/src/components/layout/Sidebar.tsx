...
import { LayoutDashboard, Tv2, Users, Tag, Film, LogOut, Radio, ListVideo, Cast, Antenna, ClipboardList, UserCog, Settings, Layers, Layers2, HardDrive, X } from 'lucide-react'
...
const primaryNav = [
  ...
  { to: '/graphic-templates', icon: Layers2, label: 'Templates' },
]
